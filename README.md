...
A -
**Your answer:**
put it at the highest level of your app, to instantiate your app and every module and dependency attached to it.
> ...
...
**Your answer:**
Immediately Invoked Function Expression to protect your variables from global scope, and as a way to initialize.
> ...
...
**Your answer:**
comes form ui.router ui-sref="index" would load the index state in the specified container.
> ...
...
**Your answer:**
```html
<my-directive> <div my-directive="blah"> <div my-directive>
```
...
**Your answer:**
C - better org. and separation of concerns. A looks decent as well.
> ...
