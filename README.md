...
**Your answer:**
theres no difference in the functionality, except data makes the html render
...
**Your answer:**
best usage would be A - that way "myapp" would be accessible to all parts of code
...
**Your answer:**
immediately invoked function expression - use this when you want a certain function to be called and executed immediately. Also, no global variables
> ...
...
**Your answer:**
this links something ( a button etc) to a link
...
**Your answer:**
line three, because don't define var i. use strict will make this throw an error
...
**Your answer:**
B is the best way. in angular the views should be close to the corresponding controllers 
